    ...
    def data_criacao_display(self) -> str:
        ...
        try:
            if self.data_criacao and isinstance(self.data_criacao, str):
                return self.data_criacao.split(' ')[0] if ' ' in self.data_criacao else self.data_criacao
            return "N/A"
...
class UserManagementService:
    ...
    def can_delete_user(self, user_id: int, current_user_id: Optional[int] = None) -> Tuple[bool, str]:
        """
