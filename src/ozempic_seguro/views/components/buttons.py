...
class VoltarButton:
    ...
    def __init__(self, master, command):
        ...
        voltar_path = os.path.abspath(os.path.join(
            os.path.dirname(__file__), "..", "..", "assets", "botao_voltar.png"
        ))
...
class FinalizarSessaoButton:
    ...
    def __init__(self, master, command):
        ...
        elipse_path = os.path.abspath(os.path.join(
            os.path.dirname(__file__), "..", "..", "assets", "elipse.png"
        ))
