...
class RepositorFrame(customtkinter.CTkFrame):
    ...
    def criar_grade_botoes(self):
        ...
        button_data = [
            {'text': "1001", 'command': lambda: messagebox.showinfo("1001","Pasta 1001"), 'name': "pasta.png"},
            {'text': "1002", 'command': lambda: messagebox.showinfo("1002","Pasta 1002"), 'name': "pasta.png"},
            {'text': "1003", 'command': lambda: messagebox.showinfo("1003","Pasta 1003"), 'name': "pasta.png"},
            {'text': "1004", 'command': lambda: messagebox.showinfo("1004","Pasta 1004"), 'name': "pasta.png"},
            {'text': "1005", 'command': lambda: messagebox.showinfo("1005","Pasta 1005"), 'name': "pasta.png"},
            {'text': "1006", 'command': lambda: messagebox.showinfo("1006","Pasta 1006"), 'name': "pasta.png"},
            {'text': "1007", 'command': lambda: messagebox.showinfo("1007","Pasta 1007"), 'name': "pasta.png"},
            {'text': "1008", 'command': lambda: messagebox.showinfo("1008","Pasta 1008"), 'name': "pasta.png"}
        ]
